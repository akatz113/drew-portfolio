export default function Footer() {
  ...
  return (
    <footer className="max-w-6xl mx-auto px-6 py-6 mt-10">
      <div className="border-t border-stone-700/50 pt-6 flex items-center justify-between">
        <p className="text-stone-600 text-sm">
          Drew Katz &middot; &copy; {year}
        </p>
