      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-zinc-100 text-sm font-medium">GE Appliances</p>
            <p className="text-zinc-400 text-xs">Mechanical Engineer</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-zinc-100 text-sm font-medium">University of Louisville</p>
            <p className="text-zinc-400 text-xs">Mechanical Engineering, M.S.</p>
          </div>
        </div>
      </div>
    </GlassCard>
